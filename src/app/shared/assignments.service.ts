...
export class AssignmentsService {
  ...
  getAssignmentsRenduOui(rendu:string, page:number, limit:number):Observable<any> {
    console.log("Dans le service de rendu ..."+rendu)
    return this.http.get<Assignment[]>(this.uriRenduOui+"/rendu="+rendu+"?page="+page + "&limit="+limit);
  }

  getAssignmentsRenduNon(rendu:string, page:number, limit:number):Observable<any> {
    console.log("Dans le service de rendu ..."+rendu)
    return this.http.get<Assignment[]>(this.uriRenduNon+"/rendu="+rendu+"?page="+page + "&limit="+limit);
  }
  ...
  getAssignmentNonRendu(id:number):Observable<Assignment> {
    //let assignementCherche = this.assignments.find(a => a.id === id);
